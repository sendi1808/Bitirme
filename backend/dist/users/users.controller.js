...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Kullanıcıların listesi başarıyla alındı.' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'ID ile kullanıcı bul' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Kullanıcı başarıyla bulundu.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Kullanıcı başarıyla silindi.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Kullanıcı bulunamadı' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
